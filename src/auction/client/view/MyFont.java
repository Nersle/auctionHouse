/*
 * name: 			字体子类
 * description：		将客户端界面用到的字体封装在一起便于代码分离
 * author:			李海
 */
...
public class MyFont {
	...
	public static Font myInfo=new Font("新宋体",Font.PLAIN,18);
	...
	public static Font loginText=new Font("幼圆",Font.PLAIN,15);
	public static Font button=new Font("幼圆",Font.PLAIN,18);
