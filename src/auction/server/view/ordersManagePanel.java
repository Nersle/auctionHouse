/*
 * name: 			管理员订单管理界面
 * description：		实现管理员订单管理界面布局及逻辑处理
 * author:			李海
 */
...
public class ordersManagePanel extends JPanel implements ActionListener, MouseListener, FocusListener {
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (e.getSource() == delete) {			
			if (delete.isEnabled()) {				
				...
				int confirm= JOptionPane.showConfirmDialog(this, "<html><font size = '5'>是否要删除选中订单信息？<br /><br /><font size = '5' color = 'red'>请注意慎重操作<br /><br />", "温馨提示", 
	...
	private void showmes() {	
		...
		orderIdt.setForeground(Color.yellow);
